...
struct CushionEnglishAtlasView: View {
    ...
    private static let coordinateSpace = "cushionEnglishAtlas"
    ...
    private var cameraToggle: some View {
        ...
        .accessibilityIdentifier("cushionEnglishAtlas.cameraMode")
    }
        ...
        if is3D {
            HStack {
                BTSceneObservationMenu(
                    ...
                    identifierPrefix: "cushionEnglishAtlas",
    ...
    private func stage(_ proxy: ShotStageProxy) -> some View {
        ZStack(alignment: .topLeading) {
            ...
            if ProcessInfo.processInfo.arguments.contains("-w2.uiHooks") {
                ...
                .accessibilityIdentifier("w2.bumpPower")
                .position(x: 52, y: 36)
                .zIndex(5)
                ...
                Text(String(format: "%.1f", vm.lastParallelSimMs))
                    ...
                    .accessibilityIdentifier("w2.parallelSimMs")
                    .position(x: 52, y: 60)
                    .zIndex(5)
            }
        }

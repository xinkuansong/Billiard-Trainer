...
| `pocket_1` | 右下角袋（+X/−Z） | +1.312 | −0.677 | 42 mm |
| `pocket_2` | 左上角袋（−X/+Z） | −1.312 | +0.677 | 42 mm |
...
> 2026-09-12 v63 W00：修正上表 pocket_1 / pocket_2 的历史顺序，按生产 TableGeometry+QiuJi 与 AngleSceneCalculator 对齐；未改变实际物理坐标或 portrait 名称映射。

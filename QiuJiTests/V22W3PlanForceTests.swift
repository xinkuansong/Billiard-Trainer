...
/// v54 起按阶段/课次保护结构不变量 + forceControl 全量归属 + dose 契约 + index 一致性。
final class V22W3PlanForceTests: XCTestCase {
    ...
    func testPlanForceDecodesAndMatchesShelfSpec() async throws {
        ...
        XCTAssertEqual(plan.stages.count, 3, "v54：力度计划包含 3 个课程阶段")
        XCTAssertEqual(plan.lessonCount, 9, "v54：力度计划包含 9 个稳定课次")
